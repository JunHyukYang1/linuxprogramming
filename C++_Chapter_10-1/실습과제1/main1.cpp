...
int main() {
    ...
    cout << "정수배열의 최대값은 " << getmax<int>(a, 5) << endl;        // 정수배열의 최대값 출력, getmax함수에 어떤 템플릿 매개변수가 쓰였는지 명시적으로 표기
    cout << "실수배열의 최대값은 " << getmax<double>(b, 4) << endl;        // 실수배열의 최대값 출력, getmax함수에 어떤 템플릿 매개변수가 쓰였는지 명시적으로 표기
    cout << "문자배열의 최대값은 " << getmax<char>(c, 3) << endl;        // 문자배열의 최대값 출력, getmax함수에 어떤 템플릿 매개변수가 쓰였는지 명시적으로 표기
}
